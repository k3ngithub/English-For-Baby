...
public class Unit {
    ...
    public Unit(String id, String unit_name, String unit_img, String lesson1_img, String lesson1, String lesson2_img, String lesson2, String lesson3_img, String lesson4) {
        this.id = id;
